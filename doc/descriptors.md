# Support for Output Descriptors in RPOcoin Core

Since RPOcoin Core v0.17, there is support for Output Descriptors. This is a
...
on RPOcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing RPOcoin Core wallets, a convenience function `combo` is
