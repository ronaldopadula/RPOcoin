...
const char * const BITCOIN_CONF_FILENAME = "rpocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RPOcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/RPOcoin";
#else
    // Unix
    return pathRet / ".rpocoin";
#endif
#endif
}
