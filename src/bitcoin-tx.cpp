...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rpocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rpocoin-tx [options] <hex-tx> [commands]  Update hex-encoded rpocoin transaction\n" +
            "or:     rpocoin-tx [options] -create [commands]   Create hex-encoded rpocoin transaction\n" +
            "\n";
