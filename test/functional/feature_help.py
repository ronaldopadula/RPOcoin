...
"""Verify that starting rpocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rpocoin with -h for help text")
        ...
        self.log.info("Start rpocoin with -version for version information")
        ...
        self.log.info("Start rpocoind with -fakearg to make sure it does not start")
